/* Lenis 1.1.18 — https://github.com/darkroomengineering/lenis (MIT)
   Vendored de cdn.jsdelivr.net/npm/lenis@1.1.18/dist/lenis.mjs.
   Não editar à mão; para atualizar, rebaixar a versão e revalidar. */
// package.json
var version = "1.1.18";
